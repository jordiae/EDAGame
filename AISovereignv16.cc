 ...
 */
#define PLAYER_NAME Sovereignv16
...
struct PLAYER_NAME : public Player {
  ...
  inline bool extra_targeted_witch(Pos pos) {
    if (already_targeted.find(pos) != already_targeted.end()) {
      return true;
    }
    /*for (int i = 0; i < 8; i++) {
      Pos pos_aux = pos+movements[i];
      if (already_targeted.find(pos_aux) != already_targeted.end())
        return true;
    }*/
    return false;
  }
